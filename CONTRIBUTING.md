...
Welcome to `opensemantic.meta.docs` contributor's guide.
...
If you experience bugs or general issues with `opensemantic.meta.docs`, please have a look
...
You can help improve `opensemantic.meta.docs` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`opensemantic.meta.docs` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `opensemantic.meta.docs`'s files. While this mechanism can
...
```
conda create -n opensemantic.meta.docs python=3 six virtualenv pytest pytest-cov
conda activate opensemantic.meta.docs
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/opensemantic.meta.docs.git
   cd opensemantic.meta.docs
   ```
...
5. Install [pre-commit]:
   ...
   `opensemantic.meta.docs` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/opensemantic.meta.docs
[issue tracker]: https://github.com/<USERNAME>/opensemantic.meta.docs/issues
